  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-conic from-emerald-500/20 via-transparent to-transparent animate-spin-slow opacity-40" />
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-conic from-indigo-500/20 via-transparent to-transparent animate-spin-slow-reverse opacity-40" />
      </div>
      ...
      {/* Floating orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-emerald-500/30 rounded-full blur-[128px] animate-pulse-slow" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-500/30 rounded-full blur-[128px] animate-pulse-slow animation-delay-2000" />
      <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-violet-500/20 rounded-full blur-[100px] animate-float" />
      ...
      <nav className="relative z-40 flex items-center justify-between px-6 py-5 md:px-12 lg:px-20">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="relative">
            <div className="absolute inset-0 bg-emerald-500 rounded-xl blur-lg opacity-50 group-hover:opacity-80 transition-opacity" />
            <div className="relative bg-gradient-to-br from-emerald-400 to-emerald-600 p-2.5 rounded-xl">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link to="/gamemodes" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">Features</Link>
          <Link to="/leaderboard" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">Leaderboard</Link>
          <Link to="/help" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">Help</Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/signup">
            <Button className="bg-white text-slate-900 hover:bg-slate-100 font-semibold shadow-lg shadow-white/10">
              Get Started
      ...
      {/* Main content */}
      <div className={`relative z-20 flex flex-col items-center justify-center min-h-[calc(100vh-100px)] px-6 transition-opacity duration-1000 ${isRevealed ? 'opacity-100' : 'opacity-50'}`}>
        <div className="max-w-5xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-full text-sm mb-8 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in-up animation-delay-600">
            <Link to="/signup">
              <Button size="lg" className="text-base px-8 py-6 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold shadow-xl shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all hover:scale-105">
                Start Learning Free
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="text-base px-8 py-6 bg-white/5 border-white/20 text-white hover:bg-white/10 hover:border-white/30">
        ...
        <div className="mt-20 grid grid-cols-3 gap-8 md:gap-16 animate-fade-in-up animation-delay-1000">
          ...
          <div className="text-center">
            ...
            <div className="text-slate-500 text-sm">Subjects</div>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">
