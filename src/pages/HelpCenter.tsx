          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger>How does the hearts system work?</AccordionTrigger>
                <AccordionContent>
                  Free users start with 5 hearts. Each failed lesson costs 1 heart. When you run out of hearts, 
                  you must wait 24 hours for them to refill. Premium users have unlimited hearts and can 
                  practice as much as they want without restrictions.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Premium subscribers get unlimited hearts, AI-powered insights on their progress, 
